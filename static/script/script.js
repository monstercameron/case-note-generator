document.addEventListener("DOMContentLoaded", () => {
    ...
    elements.generateJiraCommentButton.addEventListener("click", generateJiraComment);
    ...
    function handleFiles(files) {
      ...
      if (fileList) {
        ...
        elements.dropArea.innerHTML = "Please select valid text (.txt) or Markdown (.md) files.";
